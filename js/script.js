...
$document.ready(function () {
    ...
    var regularConstraintsMessages = [
      {
        ...
        newMessage: "Текстове поле є обов’язковим.",
      },
      {
        type: regula.Constraint.Email,
        newMessage: "Адреса електронної пошти не є дійсною.",
      },
      {
      ...
      },
      {
        ...
        newMessage: "Будь ласка, виберіть варіант.",
      },
    ];
    ...
    for (var n = 0; n < plugins.owl.length; n++) {
      ...
      for (var i = 0; i < values.length; i++) {
        ...
        for (var j = i; j >= -1; j--) {
          if (
            ...
            carousel.attr("data" + aliaces[j] + "items")
          ) {
            responsive[values[i]]["items"] =
              j < 0
                ? 1
                : parseInt(carousel.attr("data" + aliaces[j] + "items"));
          }
          if (
            !responsive[values[i]]["stagePadding"] &&
            responsive[values[i]]["stagePadding"] !== 0 &&
            carousel.attr("data" + aliaces[j] + "stage-padding")
          ) {
            responsive[values[i]]["stagePadding"] =
              j < 0
                ? 0
          ...
          if (
            ...
            carousel.attr("data" + aliaces[j] + "margin")
          ) {
            responsive[values[i]]["margin"] =
              j < 0
                ? 30
                : parseInt(carousel.attr("data" + aliaces[j] + "margin"));
          }
          if (
            !responsive[values[i]]["dotsEach"] &&
            responsive[values[i]]["dotsEach"] !== 0 &&
            carousel.attr("data" + aliaces[j] + "dots-each")
          ) {
            responsive[values[i]]["dotsEach"] =
              j < 0
                ? false
                : parseInt(carousel.attr("data" + aliaces[j] + "dots-each"));
          }
        }
      }
      ...
      carousel.owlCarousel({
        autoplay: !isNoviBuilder
          ? carousel.attr("data-autoplay") === "true"
          : false,
        ...
        mouseDrag: !isNoviBuilder
          ? carousel.attr("data-mouse-drag") === "true"
          : false,
        nav: carousel.attr("data-nav") === "true",
        dots: carousel.attr("data-dots") === "true",
        dotsEach: carousel.attr("data-dots-each")
          ? parseInt(carousel.attr("data-dots-each"))
          : false,
  ...
  if (plugins.rdNavbar.length) {
    ...
    for (var alias in aliases) {
      ...
      if (navbar.attr("data" + aliases[alias] + "layout"))
        responsiveNavbar[alias].layout = navbar.attr(
          "data" + aliases[alias] + "layout"
        );
      else responsiveNavbar[alias].layout = "rd-navbar-fixed";
      if (navbar.attr("data" + aliases[alias] + "device-layout"))
        responsiveNavbar[alias].deviceLayout = navbar.attr(
          "data" + aliases[alias] + "device-layout"
        );
      else responsiveNavbar[alias].deviceLayout = "rd-navbar-fixed";
      if (navbar.attr("data" + aliases[alias] + "hover-on"))
        responsiveNavbar[alias].focusOnHover =
          navbar.attr("data" + aliases[alias] + "hover-on") === "true";
      if (navbar.attr("data" + aliases[alias] + "auto-height"))
        responsiveNavbar[alias].autoHeight =
          navbar.attr("data" + aliases[alias] + "auto-height") === "true";
      if (navbar.attr("data" + aliases[alias] + "stick-up-offset"))
        responsiveNavbar[alias].stickUpOffset = navbar.attr(
          "data" + aliases[alias] + "stick-up-offset"
        );
      if (navbar.attr("data" + aliases[alias] + "stick-up") && !isNoviBuilder)
        responsiveNavbar[alias].stickUp =
          navbar.attr("data" + aliases[alias] + "stick-up") === "true";
    ...
    navbar.RDNavbar({
      stickUpClone:
        !isNoviBuilder && navbar.attr("data-stick-up-clone")
  ...
  if (plugins.rdMailForm.length) {
    var msg = {
      ...
      MF001: "Успішно відправлено!",
      MF002: "Успішно відправлено!",
      MF003: "Успішно відправлено!",
      MF004: "Успішно відправлено!",
      MF254: "Успішно відправлено!",
      MF255: "Успішно відправлено!",
    };
      ...
      $form.attr("novalidate", "novalidate").ajaxForm({
        ...
        beforeSubmit: function (arr, $form, options) {
          ...
          if (isValidated(inputs, captcha)) {
            ...
            if (output.hasClass("snackbars")) {
              output.html(
                '<p><span class="icon text-middle fa fa-circle-o-notch fa-spin icon-xxs"></span><span>Відправлення</span></p>'
              );
              output.addClass("active");
            }
          } else {
